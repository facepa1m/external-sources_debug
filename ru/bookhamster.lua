...
function getCatalogList(index)
  local url = baseUrl .. "vse-knigi/?sort=%D0%9F%D0%BE+%D1%80%D0%B5%D0%B9%D1%82%D0%B8%D0%BD%D0%B3%D1%83&bpage=" .. tostring(index + 1)
...
function getChapterList(bookUrl)
  ...
  -- reverseChapters = true → сайт даёт newest-first, разворачиваем в oldest-first
  local reversed = {}
